...
function Rcards() {
  return (
   <main className=' flex flex-col h-screen items-center justify-center bg-green-100 gap-6 '>
    ...
    <h1 className='text-3xl font-bold mb-6  '>Fun Facts About React</h1>
    <div className='flex'>
        <ul className='max-w-90 bg-green-600 transition-transform hover:translate-x-3 hover:-translate-y-4 p-6 rounded-lg text-white hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] divide-y divide-green-100 '>
